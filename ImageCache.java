...
public class ImageCache {
    ...
    public void addBitmapToCache(String data, Bitmap bitmap) {
        ...
        // Add to disk cache
        if (mDiskCache != null && mDiskCache.get(data) == null) {
    ...
    public static class ImageCacheParams {
        ...
        /**
         * If you want to use the memory cache, you need set this flag true.
         */
        public boolean memoryCacheEnabled = DEFAULT_MEM_CACHE_ENABLED;
        /**
         * If you want to use the disk cache, you need set this flag true.
         */
